...
CMAKE_SOURCE_DIR = /app/build/_deps/raylib-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /app/build/_deps/raylib-subbuild
...
CMakeFiles/raylib-populate-complete: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'raylib-populate'"
	/usr/bin/cmake -E make_directory /app/build/_deps/raylib-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/CMakeFiles/raylib-populate-complete
	/usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-done
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-build: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'raylib-populate'"
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-build
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-configure: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'raylib-populate'"
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-configure
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-download: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (download, verify and extract) for 'raylib-populate'"
	cd /app/build/_deps && /usr/bin/cmake -P /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/download-raylib-populate.cmake
	cd /app/build/_deps && /usr/bin/cmake -P /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/verify-raylib-populate.cmake
	cd /app/build/_deps && /usr/bin/cmake -P /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/extract-raylib-populate.cmake
	cd /app/build/_deps && /usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-download
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-install: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'raylib-populate'"
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-install

raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'raylib-populate'"
	/usr/bin/cmake -Dcfgdir= -P /app/build/_deps/raylib-subbuild/raylib-populate-prefix/tmp/raylib-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-mkdir
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-patch: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'raylib-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-patch
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-test: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'raylib-populate'"
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E echo_append
	cd /app/build/_deps/raylib-build && /usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-test
...
raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-update: raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/build/_deps/raylib-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "No update step for 'raylib-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-update
...
CMakeFiles/raylib-populate.dir/depend:
	cd /app/build/_deps/raylib-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/build/_deps/raylib-subbuild /app/build/_deps/raylib-subbuild /app/build/_deps/raylib-subbuild /app/build/_deps/raylib-subbuild /app/build/_deps/raylib-subbuild/CMakeFiles/raylib-populate.dir/DependInfo.cmake "--color=$(COLOR)"
